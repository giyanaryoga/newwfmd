...
public class GenerateIpV4Dao {
    ...
    public void insertIntegrationHistory(String wonum, String apiType, String request, String response) throws SQLException {
        ...
        String integrationHistorySet = "INSERT INTO app_fd_integration_history (WFMWOID, INTEGRATION_TYPE, PARAM1, REQUEST, RESPONSE, EXEC_DATE) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    //===========================================
    public void getSoapResponseVpn(String serviceType, String vrf, String routedistinguisher, String rtImport, String rtExport) throws JSONException, IOException, MalformedURLException, Exception {
        // Request Structure
        String request = createSoapRequestVPN(serviceType, vrf, routedistinguisher, rtImport, rtExport);
    ...
    //===========================================
    public void getSoapResponse(String serviceType, String vrf, String ipType, String ipArea, String ipVersion, String packageType) throws MalformedURLException, IOException, JSONException {
        String request = createSoapRequest(serviceType, vrf, ipType, ipArea, ipVersion, packageType);
    ...
    public String createSoapRequestVPN(String serviceType, String vrf, String routedistinguisher, String rtImport, String rtExport) {
    ...
    public String createSoapRequest(String serviceType, String vrf, String ipType, String ipArea, String ipVersion, String packageType) {
